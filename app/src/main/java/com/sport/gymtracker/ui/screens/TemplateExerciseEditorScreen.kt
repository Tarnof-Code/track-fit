...
import com.sport.gymtracker.ui.viewmodel.TemplateExerciseEditorViewModel
import com.sport.gymtracker.ui.viewmodel.defaultRestForDifficulty

@OptIn(ExperimentalMaterial3Api::class, ExperimentalLayoutApi::class)
@Composable
fun TemplateExerciseEditorScreen(
    templateId: Long,
    exerciseId: Long?,
    onBack: () -> Unit,
) {
    ...
    val vm: TemplateExerciseEditorViewModel = viewModel(
        factory = TemplateExerciseEditorViewModel.factory(app, templateId, exerciseId),
    )
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = { Text(if (exerciseId == null) "Exercice du modèle" else "Modifier l’exercice") },
                navigationIcon = {
        ...
        Column(
            ...
            Text(
                "Ce n’est qu’un exercice parmi d’autres dans le modèle : après enregistrement, reviens au programme et appuie à nouveau sur + pour en ajouter.",
            ...
            if (exerciseId == null) {
                Text(
                    "Une seule fiche exercice : elle apparaît dans la bibliothèque et se met à jour partout où tu l’utilises.",
                    style = MaterialTheme.typography.bodySmall,
                    color = MaterialTheme.colorScheme.onSurfaceVariant,
                )
            }
            ...
            Button(
                ...
                Text("Enregistrer dans le modèle")
            }
        }
    }
}
